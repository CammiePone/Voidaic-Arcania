...
public class BlockVoidCrop extends BlockCrops 
{
	...
	public BlockVoidCrop(String name)
	{
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!world.isRemote)
		{
			...
			{
				world.spawnEntity(new EntityItem(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.VOID_BULB, 1)));
