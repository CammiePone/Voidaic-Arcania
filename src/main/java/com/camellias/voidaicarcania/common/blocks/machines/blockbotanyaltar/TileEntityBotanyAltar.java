...
public class TileEntityBotanyAltar extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.botany_altar";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockBotanyAltar.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = BotanyAltarRecipes.getInstance().getBotanyAltarResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	{
		return Reference.MODID + ":gui_botany_altar";
	}
