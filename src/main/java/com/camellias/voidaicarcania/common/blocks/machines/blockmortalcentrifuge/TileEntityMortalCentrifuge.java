...
public class TileEntityMortalCentrifuge extends TileEntity implements IInventory, ITickable
{
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockMortalCentrifuge.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = MortalCentrifugeRecipes.getInstance().getCentrifugeResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = MortalCentrifugeRecipes.getInstance().getCentrifugeResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	{
		return Reference.MODID + ":gui_mortal_centrifuge";
	}
