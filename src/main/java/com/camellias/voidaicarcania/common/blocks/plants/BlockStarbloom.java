...
public class BlockStarbloom extends BlockCrops 
{
	...
	public BlockStarbloom(String name)
	{
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!world.isRemote)
		{
			...
			{
				world.spawnEntity(new EntityItem(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.STARBLOOM, 1)));
