...
public class BlockVoidTea extends BlockCrops 
{
	...
	public BlockVoidTea(String name)
	{
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!world.isRemote)
		{
			...
			{
				world.spawnEntity(new EntityItem(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.DARK_CAMELLIA, 1)));
