package com.camellias.voidaicarcania.common.blocks.plants;
...
public class BlockNeddlesprout extends BlockCrops 
{
	...
	public BlockNeddlesprout(String name)
	{
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!world.isRemote)
		{
			...
			{
				world.spawnEntity(new EntityItem(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.NEDDLESPROUT, 1)));
