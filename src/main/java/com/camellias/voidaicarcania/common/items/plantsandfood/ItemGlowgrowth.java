...
public class ItemGlowgrowth extends ItemFood implements IHasModel, IPlantable
{
	public ItemGlowgrowth(String name, int amount, float saturation, boolean isWolfFood)
	{
			...
			EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{
			world.setBlockState(pos.up(), ModBlocks.BLOCK_GLOWGROWTH.getDefaultState());
			stack.shrink(1);
	...
	{
		return ModBlocks.BLOCK_GLOWGROWTH.getDefaultState();
	}
