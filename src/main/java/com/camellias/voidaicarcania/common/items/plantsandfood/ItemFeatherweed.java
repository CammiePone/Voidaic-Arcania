...
public class ItemFeatherweed extends ItemFood implements IHasModel, IPlantable
{
	public ItemFeatherweed(String name, int amount, float saturation, boolean isWolfFood)
	{
			...
			EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{
			world.setBlockState(pos.up(), ModBlocks.BLOCK_FEATHERWEED.getDefaultState());
			stack.shrink(1);
	...
	{
		return ModBlocks.BLOCK_FEATHERWEED.getDefaultState();
	}
