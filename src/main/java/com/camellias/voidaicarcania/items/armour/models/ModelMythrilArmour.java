...
{
	public static ModelMythrilArmour INSTANCE = new ModelMythrilArmour();
    ...
    public ModelMythrilArmour()
    {
        ...
        LeftPauldron1 = new ModelRenderer(this, 0, 81);
