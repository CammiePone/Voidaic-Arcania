...
public class ModelStrengthBelt extends ModelBase
{
	public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":textures/models/model_strength_belt.png");
	
    ModelRenderer Belt;
    ModelRenderer Buckle;
  
    public ModelStrengthBelt()
    {
    	textureWidth = 32;
    	textureHeight = 32;
