...
import com.camellias.voidaicarcania.items.baubles.ModelFeastCowl;
import com.camellias.voidaicarcania.items.baubles.ModelReaperCowl;
...
public class ItemReaperCowl extends Item implements IHasModel, IBauble, IRenderBauble
{
	@SideOnly(Side.CLIENT)
	private static ModelReaperCowl model;
	
	public ItemReaperCowl(String name)
	{
	...
	public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer player, EntityLivingBase entity, EnumHand hand)
	{
		...
		{
			entity.setDead();
			player.addItemStackToInventory(new ItemStack(ModItems.A_REAPER_COWL));
			stack.shrink(1);
