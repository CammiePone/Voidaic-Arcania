...
public class ModelReaperCowl extends ModelBase
{
	public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":textures/models/model_reaper_cowl.png");
    ...
    ModelRenderer CowlFront;
    
    public ModelReaperCowl()
    {
    	textureWidth = 64;
    	textureHeight = 32;
    	...
    	CowlFront = new ModelRenderer(this, 25, 14);
    	CowlFront.addBox(-4F, -8F, -4F, 8, 9, 1);
    	CowlFront.setRotationPoint(0F, 0F, 0F);
    	setRotation(CowlFront, 0F, 0F, 0F);
    }
