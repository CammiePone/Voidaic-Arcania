...
public class ItemResistanceBelt extends Item implements IHasModel, IBauble, IRenderBauble
{
	@SideOnly(Side.CLIENT)
	private static ModelResistanceBelt model;
	
	public ItemResistanceBelt(String name)
	{
	...
	public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer player, EntityLivingBase entity, EnumHand hand)
	{
		...
		{
			entity.setDead();
			player.addItemStackToInventory(new ItemStack(ModItems.A_RESISTANCE_BELT));
			stack.shrink(1);
