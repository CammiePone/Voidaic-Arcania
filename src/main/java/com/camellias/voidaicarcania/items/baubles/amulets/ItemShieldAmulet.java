...
import com.camellias.voidaicarcania.items.baubles.ModelShieldAmulet;
...
public class ItemShieldAmulet extends Item implements IHasModel, IBauble, IRenderBauble
{
	@SideOnly(Side.CLIENT)
	private static ModelShieldAmulet model;
	
	int shieldRegen = 5 * 20;
	
	public ItemShieldAmulet(String name)
	{
	...
	public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer player, EntityLivingBase entity, EnumHand hand)
	{
		...
		{
			entity.setDead();
			player.addItemStackToInventory(new ItemStack(ModItems.A_SHIELD_AMULET));
			stack.shrink(1);
