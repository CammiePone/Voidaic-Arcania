...
public class ItemVoidCharm extends Item implements IHasModel, IBauble
{
	public ItemVoidCharm(String name)
	{
	...
	public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer player, EntityLivingBase entity, EnumHand hand)
	{
		...
		{
			entity.setDead();
			player.addItemStackToInventory(new ItemStack(ModItems.A_VOID_CHARM));
			stack.shrink(1);
