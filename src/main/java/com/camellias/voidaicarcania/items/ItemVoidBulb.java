...
public class ItemVoidBulb extends ItemFood implements IHasModel, IPlantable
{
	public ItemVoidBulb(String name, int amount, float saturation, boolean isWolfFood)
	{
			...
			EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{
			world.setBlockState(pos.up(), ModBlocks.BLOCK_VOID_CROP.getDefaultState());
			stack.shrink(1);
	...
	{
		return ModBlocks.BLOCK_VOID_CROP.getDefaultState();
	}
