...
public class ItemNeddlesprout extends ItemFood implements IHasModel, IPlantable
{
	public ItemNeddlesprout(String name, int amount, float saturation, boolean isWolfFood)
	{
			...
			EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{
			world.setBlockState(pos.up(), ModBlocks.BLOCK_NEDDLESPROUT.getDefaultState());
			stack.shrink(1);
	...
	{
		return ModBlocks.BLOCK_NEDDLESPROUT.getDefaultState();
	}
