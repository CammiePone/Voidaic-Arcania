...
public class ItemDarkCamellia extends Item implements IHasModel, IPlantable
{
	public ItemDarkCamellia(String name)
	{
			...
			EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{
			world.setBlockState(pos.up(), ModBlocks.BLOCK_VOIDTEA.getDefaultState());
			stack.shrink(1);
