...
{
	public static final HashMap<ItemStack, Integer> LIST = new HashMap<ItemStack, Integer>();
	...
	public static void init()
	{
		...
		LIST.put(chorus_fruit, 5);
		LIST.put(purpur_slab, 5);
		LIST.put(popped_chorus, 10);
		LIST.put(purpur_block, 10);
		LIST.put(purpur_pillar, 10);
		LIST.put(purpur_stairs, 15);
		LIST.put(end_stone, 20);
		LIST.put(end_bricks, 20);
		LIST.put(end_rod, 25);
		LIST.put(obsidian, 50);
		LIST.put(ender_pearl, 50);
		LIST.put(ender_eye, 75);
		LIST.put(end_crystal, 150);
		LIST.put(enchant_table, 200);
		LIST.put(bedrock, 500);
		LIST.put(ender_chest, 500);
		LIST.put(dragon_egg, 1600);
		...
		if(Main.instance.isThaumcraftLoaded == true)
		{
			...
			LIST.put(void_nugget, 17);
			LIST.put(void_seed, 100);
			LIST.put(void_ingot, 150);
			LIST.put(void_plate, 150);
			LIST.put(void_shovel, 150);
			LIST.put(vitium_crystal, 200);
			LIST.put(perditio_crystal, 200);
			LIST.put(void_hoe, 300);
			LIST.put(void_sword, 300);
			LIST.put(voidseer_pearl, 400);
			LIST.put(void_axe, 450);
			LIST.put(void_pick, 450);
			LIST.put(eldritch_curio, 500);
			LIST.put(twisted_curio, 500);
			LIST.put(crimson_rites, 500);
			LIST.put(void_boots, 600);
			LIST.put(void_helm, 750);
			LIST.put(void_robe_hood, 950);
			LIST.put(void_legs, 1050);
			LIST.put(void_chest, 1200);
			LIST.put(void_block, 1350);
			LIST.put(void_robe_legs, 1550);
			LIST.put(primordial_pearl, 1600);
			LIST.put(void_robe_chest, 1700);
			LIST.put(primal_crusher, 2400);
		}
	}
}
